...
Seaborn & Matplotlib: Creación de gráficos de dispersión y mapas de calor para visualizar los clusters.

Scikit-learn (KMeans/DBSCAN): Implementación de modelos de aprendizaje no supervisado para segmentar a los jugadores.
